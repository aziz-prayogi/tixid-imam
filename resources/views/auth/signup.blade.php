...
<body>
    ...
    <form class="w-50 d-block mx-auto my-5" method="POST" action="{{ route('signup.register') }}">
        {{-- csrf = generate token yang menjadi syarat bagi FE mengirim dara ke server/backend--}}
        @csrf
  ...
  <div class="row mb-4">
    <div class="col">
      <div data-mdb-input-init class="form-outline">
        {{-- name = "" : memberikan identitas data agar data yang diinpur bisa diakses conroller, namanya snack case bahasa inggris --}}
      ...
      {{-- memunculkan tulisan error validsi --}}
      @error('first_name')
  ...
  <!-- Password input -->
  <div data-mdb-input-init class="form-outline mb-4">
    {{-- value="{{ old('name')}} agar tidak mengisi ulang saat ada salah satu yang error  --}}
